 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://impl.cxf.wxf.com/", wsdlLocation = "http://localhost:8080/webservice/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://impl.cxf.wxf.com/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://impl.cxf.wxf.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.cxf.wxf.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
